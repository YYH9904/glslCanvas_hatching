...
uniform sampler2D u_tex1; // Hatch_0.jpeg（最亮端過渡前一層）
uniform sampler2D u_tex2; // Hatch_1.jpeg
uniform sampler2D u_tex3; // Hatch_2.jpeg
uniform sampler2D u_tex4; // Hatch_3.jpeg
uniform sampler2D u_tex5; // Hatch_4.jpeg
uniform sampler2D u_tex6; // Hatch_5.png（最暗端）
